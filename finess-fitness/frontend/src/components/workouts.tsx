...
import logoImage from './images/logonobg.png';// Import the ScrollAnimation component
import './workouts.css'
const Workouts: React.FC = () => {
  ...
  const [sidebarOpen, setSidebarOpen] = useState<boolean>(false); // Assuming you have sidebarOpen state
